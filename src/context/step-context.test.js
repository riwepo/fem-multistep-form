...
describe("step context test suite", () => {
  test.each(FIELDS)(
  ...
  test("getSelectedPlanCode returns default values", () => {
    function TestContext() {
      const stepContext = useContext(StepContext);
      ...
      return (
        <p>{`selectedPlan: ${selectedPlanCode} isStepValid: ${isStepValid} isStepInitialised: ${isStepInitialised}`}</p>
      );
    }
